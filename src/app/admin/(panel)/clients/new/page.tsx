    ...
    <>
      ...
      <form action={handleSubmit} className={formStyles.form}>
        <section className={formStyles.section}>
          ...
          <div className={formStyles.row}>
            ...
            <div className={formStyles.field}>
              ...
              <input type="text" name="nip" className={formStyles.input} placeholder="np. 5252222222" />
            </div>
          </div>
        </section>
        ...
        <section className={formStyles.section}>
          ...
          <div className={formStyles.row}>
            <div className={formStyles.field}>
              ...
              <input type="text" name="contact_person" className={formStyles.input} required />
            </div>
            <div className={formStyles.field}>
              <label className={formStyles.label}>
        ...
        <section className={formStyles.section}>
          ...
          <div className={formStyles.row}>
            <div className={formStyles.field}>
              ...
              <input type="text" name="address_postal_code" className={formStyles.input} placeholder="00-000" />
            </div>
            <div className={formStyles.field}>
        ...
        <section className={formStyles.section}>
          ...
          <textarea name="notes" rows={4} className={formStyles.textarea}></textarea>
        </section>
