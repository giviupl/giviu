...
const organizationJsonLd = {
  ...
  description:
    "Prezenty firmowe premium od najlepszych marek. Stanley, Moleskine, The North Face z personalizacją.",
  contactPoint: {
    "@type": "ContactPoint",
    contactType: "sales",
...
const localBusinessJsonLd = {
  ...
  url: "https://giviu.pl",
  description:
    "Prezenty firmowe premium z personalizacją. Stanley, Moleskine, The North Face dla firm.",
  address: {
    "@type": "PostalAddress",
