...
export const metadata: Metadata = {
  ...
  description:
    "Ekologiczne gadżety reklamowe z certyfikatami. Materiały z recyklingu, odpowiedzialna produkcja. Prezenty firmowe, które nie szkodzą planecie.",
...
const MATERIALS = [
  {
    ...
    description:
      "Wybieramy surowce, które mogą krążyć w obiegu zamkniętym w nieskończoność. Stosujemy stal nierdzewną typu 18/8 oraz recyklingowane aluminium. To materiały klasy spożywczej, które nie wchodzą w reakcje z napojami, gwarantując sterylność, neutralność smaku i industrialną wytrzymałość.",
    image: "/images/ekologia/stal.webp",
  },
  {
    title: "Bawełna GOTS, rPET i wełna merino",
    description:
      "Od certyfikowanych upraw po drugie życie plastiku. Stawiamy na włókna rPET, naturalną wełnę merino oraz bawełnę organiczną spełniającą standardy GOTS. To gwarancja, że tekstylia są wolne od pestycydów i metali ciężkich, a przy tym zachowują najwyższe parametry oddychalności.",
    image: "/images/ekologia/tekstylia.webp",
  },
  {
    title: "Tritan™ Renew i innowacyjne tworzywa",
    description:
      "Technologia w służbie ekologii. Wybieramy Eastman Tritan™ Renew – rewolucyjny materiał, który w 50% powstaje z recyklingu. Jest wolny od BPA/BPS, nie chłonie zapachów i nie mętnieje w zmywarce. To ta sama legendarna wytrzymałość co w oryginale, ale przy znacznie mniejszym śladzie węglowym.",
    image: "/images/ekologia/tritan.webp",
  },
];
  ...
  return (
    <main className={styles["ekologia-page"]}>
      ...
      <ContentBlock
        ...
        image="/images/ekologia/hero.webp"
      />
      ...
      <ContentBlock
        ...
        image="/images/ekologia/odpowiedzialnosc.webp"
      />
      ...
      <section className={styles["ekologia-verify"]}>
        <div className={styles["ekologia-verify-header"]}>
          <div className={styles["ekologia-verify-title-wrapper"]}>
            ...
            <h2 className={styles["ekologia-verify-title"]}>
              Odpowiedzialność, którą można zweryfikować.
            </h2>
          </div>
          <p className={styles["ekologia-verify-description"]}>
            W ekologii nie uznajemy półśrodków ani marketingu bez pokrycia.
            Zamiast wierzyć na słowo, wymagamy dowodów. Prześwietlamy
            certyfikaty i pochodzenie materiałów, by dać Ci pewność, że
            wybierasz produkty, które są odpowiedzialne naprawdę, a nie tylko z
            nazwy.
          </p>
        </div>

        <div className={styles["ekologia-certificates"]}>
          <h3 className={styles["ekologia-certificates-title"]}>
        ...
        <div className={styles["ekologia-materials"]}>
          <h3 className={styles["ekologia-materials-title"]}>
            ...
            {MATERIALS.map((material, index) => (
              <div key={index} className={styles["ekologia-material-item"]}>
                <div className={styles["ekologia-material-placeholder"]}>
                  {material.image ? (
                    <img
                      src={material.image}
                      alt={material.title}
                      className={styles["ekologia-material-img"]}
                    />
                  ) : (
                    <svg
                      className={styles["ekologia-placeholder-icon"]}
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                    >
                ...
                <div className={styles["ekologia-material-content"]}>
                  <h4 className={styles["ekologia-material-title"]}>
                    {material.title}
                  </h4>
                  <p className={styles["ekologia-material-description"]}>
      ...
      <ContentBlock
        ...
        image="/images/ekologia/logistyka.webp"
      />
