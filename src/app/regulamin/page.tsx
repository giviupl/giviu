      ...
      <div className="legal-container">
        ...
        <div className="legal-content">
          ...
          <section className="legal-section">
            ...
            <p>
              Niniejszy Regulamin określa zasady korzystania ze strony internetowej [adres strony], 
              prowadzonej przez [Nazwa firmy] z siedzibą w [Adres], NIP: [NIP], REGON: [REGON].
            </p>
            <p>
          ...
          <section className="legal-section">
            ...
            <p>
              Za pośrednictwem Strony Usługodawca świadczy następujące usługi:
            </p>
            <ul>
            ...
            <p>
              Strona nie jest sklepem internetowym. Prezentowane ceny mają charakter orientacyjny 
              i nie stanowią oferty handlowej w rozumieniu Kodeksu Cywilnego.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Użytkownik może złożyć zapytanie ofertowe poprzez formularz dostępny na Stronie. 
              Złożenie zapytania nie jest równoznaczne z zawarciem umowy.
            </p>
            <p>
              Po otrzymaniu zapytania, Usługodawca przygotuje indywidualną ofertę i skontaktuje się 
              z Użytkownikiem w ciągu 24 godzin roboczych.
            </p>
            <p>
              Warunki realizacji zamówienia, w tym ceny, terminy i warunki dostawy, są ustalane 
          ...
          <section className="legal-section">
            ...
            <p>
              Wszelkie treści zamieszczone na Stronie, w tym teksty, grafiki, logotypy, zdjęcia 
              i elementy interaktywne, są własnością Usługodawcy lub podmiotów, z którymi Usługodawca 
              współpracuje, i są chronione prawem autorskim.
            </p>
            <p>
              Kopiowanie, rozpowszechnianie lub wykorzystywanie materiałów ze Strony bez zgody 
          ...
          <section className="legal-section">
            ...
            <p>
              Usługodawca dokłada wszelkich starań, aby informacje zamieszczone na Stronie były 
              aktualne i zgodne ze stanem faktycznym. Nie ponosi jednak odpowiedzialności za 
              ewentualne błędy lub nieścisłości.
            </p>
            <p>
              Usługodawca nie ponosi odpowiedzialności za przerwy w dostępie do Strony wynikające 
              z przyczyn technicznych lub okoliczności niezależnych od Usługodawcy.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              ...
              w życie z chwilą ich publikacji na Stronie.
            </p>
            <p>
              Korzystanie ze Strony po wprowadzeniu zmian oznacza akceptację nowego Regulaminu.
            </p>
          </section>
          ...
          <section className="legal-section">
            ...
            <p>
              Wszelkie spory wynikające z korzystania ze Strony będą rozstrzygane przez sąd 
