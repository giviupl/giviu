      ...
      <div className={styles['legal-container']}>
        ...
        <header className={styles['legal-header']}>
          <div className={styles['legal-title-wrapper']}>
            ...
            <h1 className={styles['legal-title']}>Polityka Prywatności</h1>
          </div>
        ...
        <div className={styles['legal-content']}>
          ...
          <section className={styles['legal-section']}>
            ...
            <p>Administratorem Twoich danych osobowych jest [Nazwa firmy] z siedzibą w [Adres], wpisana do rejestru przedsiębiorców pod numerem NIP: [NIP], REGON: [REGON].</p>
            <p>W sprawach związanych z ochroną danych osobowych możesz skontaktować się z nami pod adresem e-mail: [email] lub telefonicznie: [telefon].</p>
          </section>
          ...
          <section className={styles['legal-section']}>
            ...
            <p>Twoje dane przechowujemy przez okres niezbędny do realizacji celów, dla których zostały zebrane, a następnie przez okres wymagany przepisami prawa (np. dla celów podatkowych – 5 lat od końca roku kalendarzowego).</p>
          </section>
          ...
          <section className={styles['legal-section']}>
            ...
            <p>Aby skorzystać z powyższych praw, skontaktuj się z nami pod adresem: [email].</p>
          </section>

          <section className={styles['legal-section']}>
            <h2>7. Pliki cookies</h2>
            <p>Nasza strona wykorzystuje pliki cookies w celu zapewnienia prawidłowego działania, analizy ruchu oraz personalizacji treści. Szczegółowe informacje znajdziesz w naszej <Link href="/cookies">Polityce Cookies</Link>.</p>
          </section>

          <section className={styles['legal-section']}>
            <h2>8. Zmiany w polityce prywatności</h2>
            <p>Zastrzegamy sobie prawo do wprowadzania zmian w niniejszej Polityce Prywatności. O wszelkich zmianach będziemy informować poprzez aktualizację daty na górze strony.</p>
          </section>

          <section className={styles['legal-section']}>
            <h2>9. Kontakt</h2>
            <p>W przypadku pytań dotyczących niniejszej Polityki Prywatności lub przetwarzania Twoich danych osobowych, skontaktuj się z nami:</p>
