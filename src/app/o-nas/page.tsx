...
export const metadata: Metadata = {
  ...
  description:
    "Poznaj Giviu — ekspercki dobór prezentów firmowych premium. Ponad 15 lat doświadczenia w branży B2B. Stanley, Moleskine, The North Face z personalizacją.",
  alternates: { canonical: "/o-nas" },
  openGraph: {
    title: "O Giviu — Prezenty Firmowe z Pasją do Jakości",
    description:
      "Poznaj Giviu — ekspercki dobór prezentów firmowych premium. Ponad 15 lat doświadczenia w branży B2B.",
    url: "/o-nas",
  },
};
  ...
  return (
    <main className={styles["o-giviu-page"]}>
      ...
      <ContentBlock
        ...
        image="/images/o-nas/selekcja.webp"
      />
      <ContentBlock
        layout="text-left"
        ...
        image="/images/o-nas/produkty.webp"
      />
      <ContentBlock
        layout="text-right"
        ...
        image="/images/o-nas/liderzy.webp"
      />

      <section className={styles["o-giviu-facts"]}>
        <div className={styles["o-giviu-facts-header"]}>
          <SectionLine spacing="sm" />
          <h2 className={styles["o-giviu-facts-title"]}>
            Decyzje oparte na faktach, nie na domysłach
          </h2>
          <p className={styles["o-giviu-facts-description"]}>
            Nasze podejście to nie tylko estetyka – to czysta matematyka i
            odpowiedzialność. Opieramy się na globalnych standardach
            wyznaczanych przez ASI (Advertising Specialty Institute), PPAI
            (Promotional Products Association International) oraz wytycznych ONZ
            dotyczących zrównoważonego rozwoju.
          </p>
          <p className={styles["o-giviu-facts-subtitle"]}>
        ...
        <div className={styles["o-giviu-facts-grid"]}>
          {[
            {
              title: "Siła Retencji (ASI)",
              text: "Produkty premium są używane średnio 16 miesięcy – to niemal 2x dłużej niż standardowe gadżety. Twój logotyp pracuje przez prawie półtora roku, co drastycznie obniża realny koszt dotarcia (CPI) i zwiększa skuteczność reklamy.",
            },
            {
              title: "Transfer Prestiżu (PPAI)",
              text: "Aż 72% odbiorców utożsamia jakość upominku z reputacją firmy. To kluczowy punkt styku z marką. Wręczając produkt uznanej klasy, budujesz prestiż i zaufanie, a przy tym automatycznie pozycjonujesz się w roli lidera jakości.",
            },
            {
              title: "Wsparcie celów ESG",
              text: 'Wspieramy model „kupuj mniej, ale lepiej". Wybór trwałych produktów to realna realizacja celów zrównoważonego rozwoju, a nie tylko pusty slogan. Zamiast generować kolejne odpady, inwestujesz w przedmioty, które służą latami.',
            },
          ].map((fact, i) => (
      ...
      <section className={styles["o-giviu-cta"]}>
        <div className={styles["o-giviu-cta-container"]}>
          <h2 className={styles["o-giviu-cta-title"]}>
            Przejdź od teorii do konkretów.
            <br />
            Znajdź towarzystwo godne Twojego logo.
          </h2>
          <p className={styles["o-giviu-cta-description"]}>
            Zobacz pełne portfolio światowych brandów, które są gotowe pracować
            na Twój sukces.
          </p>
          <Link href="/marki" className={styles["o-giviu-cta-button"]}>
            ODKRYJ NASZE MARKI
          </Link>
        </div>
      </section>
