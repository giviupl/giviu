...
export const metadata: Metadata = {
  ...
  description:
    "Od briefu do dostawy w 4 krokach. Doradztwo, personalizacja, kontrola jakości. Zamów prezenty firmowe premium bez stresu.",
...
const PROCESS_STEPS = [
  {
    ...
    description:
      "Opowiedz nam o okazji, grupie odbiorców i budżecie. Dobierzemy produkty i metody znakowania. Wycenę otrzymasz w 24h.",
    icon: (
      <svg
        width="32"
        height="32"
  ...
  },
  {
    ...
    description:
      "Nie przeszukujesz tysięcy produktów. Przygotujemy starannie dobraną propozycję — tylko sprawdzone marki i produkty, które przeszły naszą weryfikację jakości.",
    icon: (
      <svg
        width="32"
        height="32"
  ...
  },
  {
    ...
    description:
      "Zatwierdzasz wizualizację logo na produkcie. Po akceptacji uruchamiamy znakowanie z pełną kontrolą jakości.",
    icon: (
      <svg
        width="32"
        height="32"
  ...
  },
  {
    ...
    description:
      "Dostarczymy do siedziby firmy lub wyślemy indywidualnie do każdego odbiorcy. Estetyczne pakowanie gotowe do wręczenia.",
    icon: (
      <svg
        width="32"
        height="32"
...
const BRANDING_METHODS = [
  {
    ...
    image: "/images/jak-dzialamy/grawer.webp",
  },
  {
    title: "Tłoczenie",
    description:
    ...
    image: "/images/jak-dzialamy/tloczenie.webp",
  },
  {
    ...
    image: "/images/jak-dzialamy/haft.webp",
  },
  {
    title: "Druk DTF",
    description:
    ...
    application:
      "Odzież bawełniana i syntetyczna, gdzie wymagana jest wysoka szczegółowość",
    effect:
      "Elastyczny, gładki w dotyku nadruk o wysokiej rozdzielczości i trwałości",
    image: "/images/jak-dzialamy/dtf.webp",
  },
  {
    title: "Druk UV",
    description:
    ...
    application:
      "Gadżety elektroniczne, notesy, płaskie powierzchnie z tworzyw",
    effect:
      "Żywe kolory, idealne odwzorowanie gradientów, natychmiastowe utrwalenie",
    image: "/images/jak-dzialamy/druk-uv.webp",
  },
  {
    title: "Sitodruk",
    description:
    ...
    image: "/images/jak-dzialamy/sitodruk.webp",
  },
  {
    title: "Termotransfer",
    description:
    ...
    image: "/images/jak-dzialamy/termotransfer.webp",
  },
  {
    title: "Tampodruk",
    description:
      'Technika druku, wykorzystująca elastyczny silikonowy stempel ("tampon"). Dzięki swojej plastyczności dopasowuje się on do kształtu podłoża, umożliwiając znakowanie powierzchni zakrzywionych, wklęsłych lub wypukłych.',
    application:
      "Długopisy, kubki, drobna elektronika, breloki, elementy o nieregularnych kształtach",
    effect:
      "Precyzyjne odwzorowanie drobnych detali na trudnych powierzchniach, czyste krawędzie",
    image: "/images/jak-dzialamy/tampodruk.webp",
  },
];
...
const COOPERATION_TILES = [
  {
    ...
    description:
      "Żadne zdjęcie nie zastąpi fizycznego kontaktu. Udostępniamy wzory produktów, abyś mógł wziąć je do ręki, poczuć fakturę materiału i ocenić detale wykończenia. Decyzję podejmujesz w oparciu o realne odczucia i pewność, a nie tylko cyfrowy obrazek na ekranie.",
  },
  {
    title: "Akceptacja wizualizacji",
    description:
      "Eliminujemy ryzyko błędu. Przed startem produkcji otrzymujesz od nas wierną wizualizację. Widzisz dokładnie, jak logotyp prezentuje się na gotowym produkcie. To czas na Twój spokój i pewność, że finalny efekt będzie perfekcyjnym odwzorowaniem Twojej wizji.",
  },
  {
    title: "Komfort wręczania",
    description:
      "Szanujemy Twój czas, dlatego omijasz żmudny etap logistyki. Otrzymujesz estetycznie spakowane produkty, które wręczysz swoim klientom z prawdziwą przyjemnością. Na życzenie zadbamy też o detale, takie jak personalizowane bileciki czy ozdobne owijki.",
  },
];
  ...
  return (
    <main className={styles["jak-dzialamy-page"]}>
      ...
      <ContentBlock
        ...
        image="/images/jak-dzialamy/hero.webp"
      />
      ...
      <section className={styles["jak-dzialamy-process"]}>
        <div className={styles["jak-dzialamy-process-header"]}>
          <div className={styles["jak-dzialamy-process-title-wrapper"]}>
            ...
            <h2 className={styles["jak-dzialamy-process-title"]}>
              Proces realizacji
            </h2>
          </div>
        </div>
          ...
          {PROCESS_STEPS.map((step) => (
            <div key={step.id} className={styles["jak-dzialamy-process-card"]}>
              <div className={styles["jak-dzialamy-process-card-header"]}>
                <span className={styles["jak-dzialamy-process-number"]}>
                  0{step.id}
                </span>
                <span className={styles["jak-dzialamy-process-icon"]}>
                  {step.icon}
                </span>
              </div>
              <h3 className={styles["jak-dzialamy-process-card-title"]}>
                {step.title}
              </h3>
              <p className={styles["jak-dzialamy-process-card-desc"]}>
                {step.description}
              </p>
            </div>
          ))}
      ...
      <section className={styles["jak-dzialamy-branding"]}>
        <div className={styles["jak-dzialamy-branding-header"]}>
          <div className={styles["jak-dzialamy-branding-title-wrapper"]}>
            <SectionLine spacing="sm" />
            <h2 className={styles["jak-dzialamy-branding-title"]}>
              Znakowanie, które uszlachetnia produkt.
            </h2>
          </div>
          <p className={styles["jak-dzialamy-branding-description"]}>
            Wierzymy, że branding powinien być dyskretny i elegancki. Korzystamy
            z technologii, które pozwalają zachować unikalny charakter
            materiałów, jednocześnie trwale eksponując Twoją markę.
          </p>
        </div>
          ...
          {BRANDING_METHODS.map((method, index) => (
            <div key={index} className={styles["jak-dzialamy-branding-item"]}>
              <div className={styles["jak-dzialamy-branding-placeholder"]}>
                {method.image ? (
                  <img
                    src={method.image}
                    alt={method.title}
                    className={styles["jak-dzialamy-branding-img"]}
                  />
                ) : (
                  <svg
                    className={styles["jak-dzialamy-placeholder-icon"]}
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                  >
              ...
              <div className={styles["jak-dzialamy-branding-content"]}>
                <h3 className={styles["jak-dzialamy-branding-method-title"]}>
                  {method.title}
                </h3>
                <p className={styles["jak-dzialamy-branding-method-desc"]}>
                  {method.description}
                </p>
      ...
      <section className={styles["jak-dzialamy-cooperation"]}>
        <div className={styles["jak-dzialamy-cooperation-header"]}>
          <div className={styles["jak-dzialamy-cooperation-title-wrapper"]}>
            <SectionLine spacing="sm" />
            <h2 className={styles["jak-dzialamy-cooperation-title"]}>
        ...
        <div className={styles["jak-dzialamy-cooperation-grid"]}>
          {COOPERATION_TILES.map((tile, index) => (
            <div
              key={index}
              className={styles["jak-dzialamy-cooperation-tile"]}
            >
              <SectionLine vertical />
              <div className={styles["jak-dzialamy-cooperation-content"]}>
                <h3 className={styles["jak-dzialamy-cooperation-tile-title"]}>
                  {tile.title}
                </h3>
                <p className={styles["jak-dzialamy-cooperation-tile-desc"]}>
                  {tile.description}
                </p>
              </div>
            </div>
      ...
      <section className={styles["jak-dzialamy-cta"]}>
        <div className={styles["jak-dzialamy-cta-container"]}>
          ...
          <p className={styles["jak-dzialamy-cta-description"]}>
            Znasz nasze standardy logistyki i znakowania.
            <br />
            Zobacz, jak łączymy je z ofertą premium.
            <br />
            Zainspiruj się, skompletuj listę faworytów i wyślij jedno, zbiorcze
            zapytanie do wyceny.
          </p>
