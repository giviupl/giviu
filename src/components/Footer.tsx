...
function NewsletterForm() {
  ...
  const isFormValid =
    formData.name && formData.email && isValidEmail(formData.email);
  ...
  const getFieldErrorClass = (field: "name" | "email") => {
    ...
    if (field === "email" && formData.email && !isValidEmail(formData.email))
      return styles["footer-input-error"];
  ...
  if (newsletterSuccess) {
    return (
      <p className={styles["footer-success"]} role="alert" aria-live="polite">
        Dziękujemy za dołączenie! Wkrótce otrzymasz od nas inspirujące
        wiadomości.
      </p>
    );
  }
  ...
  return (
    <footer role="contentinfo" className={styles["footer-container"]}>
      <div className={styles["footer-inner"]}>
        {/* Desktop Layout */}
        <div
          className={`${styles["footer-columns"]} ${styles["footer-desktop"]}`}
        >
          {/* Column 1 - Newsletter */}
          <section
            className={styles["footer-newsletter"]}
          ...
          >
            ...
            <p className={styles["footer-desc"]}>
              Zapisz się na newsletter i dowiaduj się pierwszy o nowościach oraz
              trendach w upominkach biznesowych.
            </p>
          ...
          <div className={styles["footer-right"]}>
            ...
            >
              <h2
                ...
                className={styles["footer-col-title"]}
              >
                Kategorie
              </h2>
              <ul className={styles["footer-list"]}>
                ...
                <li>
                  <Link href="/marki" className={styles["footer-link"]}>
                    Marki
                  </Link>
                </li>
                <li>
                  <Link href="/nowosci" className={styles["footer-link"]}>
                    Nowości
                  </Link>
                </li>
              </ul>
            ...
            >
              ...
              <ul className={styles["footer-list"]}>
                <li>
                  <Link href="/inspiracje" className={styles["footer-link"]}>
                    Inspiracje
                  </Link>
                </li>
                <li>
                  <Link href="/o-nas" className={styles["footer-link"]}>
                    O Giviu
                  </Link>
                </li>
                <li>
                  <Link href="/jak-dzialamy" className={styles["footer-link"]}>
                    Jak działamy
                  </Link>
                </li>
                <li>
                  <Link href="/ekologia" className={styles["footer-link"]}>
                    Ekologia
                  </Link>
                </li>
                <li>
                  <Link href="/faq" className={styles["footer-link"]}>
                    FAQ
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/regulamin" className={styles["footer-link"]}>
                    Regulamin
                  </Link>
                </li>
                <li>
            ...
            {/* Column 4 - Kontakt */}
            <section
              className={`${styles["footer-col"]} ${styles["footer-col-last"]}`}
        ...
        <div className={styles["footer-mobile"]}>
          <section
            className={styles["footer-mobile-section"]}
